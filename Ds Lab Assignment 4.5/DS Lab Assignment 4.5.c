...
/* create a new node with the given data */ struct treeNode* createNode(int data)
{
...
/* search the given element in binary search tree */ void findElement(struct treeNode *node, int data) { if (!node)
return;
else if (data < node->data)
{
